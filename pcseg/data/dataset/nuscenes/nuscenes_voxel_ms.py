...
from .nuscenes_ms import NuscenesMsDataset
...
class NuscVoxelMsDataset(data.Dataset):
    def __init__(
        self,
        data_cfgs=None,
        training=True,
        ...
        if self.data_cfgs.DATASET == 'nuscenes_ms':
            self.point_cloud_dataset = NuscenesMsDataset(
                data_cfgs=data_cfgs,
                training=training,
