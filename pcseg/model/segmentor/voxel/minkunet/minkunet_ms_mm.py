...
class MinkUNetMsMm(BaseSegmentor):    
    def __init__(
        self,
        model_cfgs,
        num_class: int,
    ...
    def forward(self, batch_dict, return_logit=False, return_tta=False):
        ...
        image_targets_fov = batch_dict['image_targets_fov']
        ...
        if self.training:
            ...
            loss_image_lidar = self.criterion_losses(image_lidar_logits_fov, image_targets_fov.to(target_ms.dtype)) * self.image_lidar_weight
