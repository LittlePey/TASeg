...
class MinkUNetMs(BaseSegmentor):    
    def __init__(
        self,
        model_cfgs,
        num_class: int,
    ...
    def forward(self, batch_dict, return_logit=False, return_tta=False):
        ...
        out_ms = self.classifier(torch.cat([z1_ms.F, z2_ms.F, z3_ms.F], dim=1))
        ...
        if self.training:
            ...
            loss = self.criterion_losses(out_ms, target_ms, xyz=coords_xyz_ms, offset=offset_ms)
