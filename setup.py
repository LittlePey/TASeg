...
if __name__ == '__main__':
    ...
    setup(
        name='pcseg',
        version=version,
        description='PCSeg is a general codebase for 3D semantic segmentation from point cloud',
        install_requires=[
            'numpy',
            'llvmlite',
            'numba',
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                ...
                module='pcseg.ops.roiaware_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='pcseg.ops.roipoint_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='pcseg.ops.pointnet2.pointnet2_stack',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='pcseg.ops.pointnet2.pointnet2_batch',
                sources=[
                    'src/pointnet2_api.cpp',
                    'src/ball_query.cpp',
                    'src/ball_query_gpu.cu',
