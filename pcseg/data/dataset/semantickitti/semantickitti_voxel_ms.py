...
from .semantickitti_ms import SemantickittiMsDataset
...
class SemkittiVoxelMsDataset(data.Dataset):
    def __init__(
        self,
        data_cfgs=None,
        training=True,
        ...
        if self.data_cfgs.DATASET == 'semantickitti_ms':
            self.point_cloud_dataset = SemantickittiMsDataset(
                data_cfgs=data_cfgs,
                training=training,
