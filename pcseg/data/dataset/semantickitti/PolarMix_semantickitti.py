...
def polarmix(pts1, labels1, pts2, labels2, alpha, beta, instance_classes, Omega, swap_flag=None, rotate_flag=None, return_strategy=False):
    ...
    if return_strategy:
        return pts_out, labels_out, swap_flag, rotate_flag
    else:
