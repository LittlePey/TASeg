...
def aug_points_ms(
    ...
    if if_jitter:
        ...
        xyz += noise_translate
        xyz_ms += noise_translate
    
    return xyz, xyz_ms

def aug_points_ms_gt(
    xyz: np.array,
    xyz_ms: np.array,
    xyz_ms_gt: np.array,
    if_flip: bool = False,
    ...
    if if_rotate:
        ...
        xyz = np.dot(xyz, rot_mat)
        xyz_ms = np.dot(xyz_ms, rot_mat)
        xyz_ms_gt = np.dot(xyz_ms_gt, rot_mat)
    ...
    if if_scale:
        ...
        xyz = xyz * scale_factor
        xyz_ms = xyz_ms * scale_factor
        xyz_ms_gt = xyz_ms_gt * scale_factor
    ...
    if if_flip:
        ...
        if flip_type == 1:
            xyz[:, 0] = -xyz[:, 0]
            xyz_ms[:, 0] = -xyz_ms[:, 0]
            xyz_ms_gt[:, 0] = -xyz_ms_gt[:, 0]
        elif flip_type == 2:
            xyz[:, 1] = -xyz[:, 1]
            xyz_ms[:, 1] = -xyz_ms[:, 1]
            xyz_ms_gt[:, 1] = -xyz_ms_gt[:, 1]
        elif flip_type == 3:
            xyz[:, :2] = -xyz[:, :2]
            xyz_ms[:, :2] = -xyz_ms[:, :2]
            xyz_ms_gt[:, :2] = -xyz_ms_gt[:, :2]
    ...
    if if_jitter:
        ...
        xyz += noise_translate
        xyz_ms += noise_translate
        xyz_ms_gt += noise_translate
    
    return xyz, xyz_ms, xyz_ms_gt

def aug_points_rgb_ms(
    xyz: np.array,
    xyz_ms: np.array,
    xyz_rgb_ms: np.array,
    if_flip: bool = False,
    ...
    if if_rotate:
        ...
        xyz = np.dot(xyz, rot_mat)
        xyz_ms = np.dot(xyz_ms, rot_mat)
        xyz_rgb_ms = np.dot(xyz_rgb_ms, rot_mat)
    ...
    if if_scale:
        ...
        xyz = xyz * scale_factor
        xyz_ms = xyz_ms * scale_factor
        xyz_rgb_ms = xyz_rgb_ms * scale_factor
    ...
    if if_flip:
        ...
        if flip_type == 1:
            xyz[:, 0] = -xyz[:, 0]
            xyz_ms[:, 0] = -xyz_ms[:, 0]
            xyz_rgb_ms[:, 0] = -xyz_rgb_ms[:, 0]
        elif flip_type == 2:
            xyz[:, 1] = -xyz[:, 1]
            xyz_ms[:, 1] = -xyz_ms[:, 1]
            xyz_rgb_ms[:, 1] = -xyz_rgb_ms[:, 1]
        elif flip_type == 3:
            xyz[:, :2] = -xyz[:, :2]
            xyz_ms[:, :2] = -xyz_ms[:, :2]
            xyz_rgb_ms[:, :2] = -xyz_rgb_ms[:, :2]
    ...
    if if_jitter:
        ...
        xyz += noise_translate
        xyz_ms += noise_translate
        xyz_rgb_ms += noise_translate
    
    return xyz, xyz_ms, xyz_rgb_ms
